"""
HTTP MCP client for Defender cache MCP server.
Set DEFENDER_MCP_URL e.g. http://127.0.0.1:8766/mcp
"""
...
def _url() -> str:
    return os.environ.get("DEFENDER_MCP_URL", "http://127.0.0.1:8766/mcp").strip().rstrip("/")
...
def initialize() -> tuple[dict, str | None]:
    msg = {
        ...
        "id": 1,
        "method": "initialize",
        "params": {"protocolVersion": "2024-11-05", "capabilities": {}, "clientInfo": {"name": "defender-mcp-client", "version": "0.1.0"}},
    }
    resp = _post(msg)
